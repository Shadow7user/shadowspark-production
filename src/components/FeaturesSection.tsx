...
const features = [
  ...
  { icon: BarChart3,   title: "BI Dashboards",        description: "Real-time analytics on leads, revenue, and customer behaviour. Make data-driven decisions with clear data." },
  ...
  { icon: Shield,      title: "Enterprise Security",  description: "TLS 1.3, AES-256, NDPR-aware data handling, role-based access control. Your data stays in your control." },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <Reveal stagger className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <div
              key={f.title}
              className="card-lift group glass-card rounded-2xl p-6 hover:border-[#d4a843]/20"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#d4a843]/8 transition-colors duration-200 group-hover:bg-[#d4a843]/15">
