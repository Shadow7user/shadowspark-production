...
const services = [
  {
    ...
    description:
      "Automated 24/7 customer support that handles FAQs, takes orders, and qualifies leads without human input.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Fast, mobile-first websites optimized for Nigerian connectivity. SEO-ready, conversion-focused design.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Connect your tools. Automate repetitive tasks. Reduce human error and scale operations instantly.",
    stats: [
  ...
  },
  {
    ...
    description:
      "React Native apps that work on Android and iOS. Native performance, single codebase, fast delivery.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Pure Swift iOS apps built for App Store launch. Optimized UI, App Store optimization included.",
    stats: [
  ...
  },
  {
    ...
    description:
      "Full-stack SEO: technical audit, content strategy, backlinks, and monthly ranking reports.",
    stats: [
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${service.iconColor} rounded-xl flex items-center justify-center`}
                  >
