    ...
    <div className="flex min-h-[90vh] flex-col items-center justify-center border-b border-white/5 relative bg-black">
      ...
      <section className="relative w-full pt-32 pb-16 flex flex-col items-center text-center px-6 overflow-hidden z-10">
        ...
        <div className="relative max-w-4xl mt-12 mb-20">
          <div className="inline-block mb-8 px-4 py-1.5 rounded-full border border-cyan-400/30 bg-cyan-400/10 text-cyan-300 text-[10px] sm:text-xs font-mono tracking-widest uppercase shadow-[0_0_15px_rgba(0,229,255,0.15)] backdrop-blur-md">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            {/* The Trigger */}
            <Button size="lg" className="h-16 px-10 text-lg rounded-xl font-mono uppercase tracking-widest font-extrabold group bg-[#00E5FF] text-black hover:bg-cyan-200 shadow-[0_0_30px_rgba(0,229,255,0.3)] transition-all" asChild>
            ...
            >
              <MessageCircle className="w-5 h-5 text-cyan-500" /> Consult Architect
            </Link>
          </div>
        </div>
      </section>
